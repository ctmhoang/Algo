...
def get_april_birthdays(people):
    ...
    april_borns_index = [i for i in range(
        len(people)) if people[i].birthday_month == 'April']
    for i in april_borns_index:
        people[i].birthday()
    april_birthdays = {person.name: person.age
                       for i, person in enumerate(people) if i in april_borns_index}
